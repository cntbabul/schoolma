                                ...
                                data={
                                    {
                                        ...
                                        birthday: "12/12/2022",
                                        gender: "Male",
                                        image: "https://images.pexels.com/photos/10319784/pexels-photo-10319784.jpeg",
                                        password: "123456",
                                        firstName: "Teacher",
                                        lastName: "Name",
            ...
            <div className='w-full xl:w-1/3 flex flex-col gap-4'>
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        ...
                        <Link href="/" className='p-3 rounded-md bg-lamaPurpleLight'>Teacher&apos;s Attendance</Link>
                        <Link href="/" className='p-3 rounded-md bg-lamaSky'>Teacher&apos;s Branch</Link>
